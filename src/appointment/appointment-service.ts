...
export const post = (id: string, date: string, startTime: number, endTime: number, name: string, description: string): Promise<any> => {
    return new Promise(async (resolve, reject) => {
        ...
        try {
            ...
            await appointmentDAO.create(id, date, startTime, endTime, name, description);
